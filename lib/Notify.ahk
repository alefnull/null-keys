...
Class NotifyClass{
	__New(Margin:=10){
		...
		(Info?Info:Info:=[])
		for a,b in {Background:"0x232323",Color:"0xDDDDDD",TitleColor:"0xDDDDDD",Font:"CaskaydiaCove NF",TitleSize:22,TitleFont:"CaskaydiaCove NF",Size:22,Font:"CaskaydiaCove NF",IconSize:20}
			if(Info[a]="")
				Info[a]:=b
